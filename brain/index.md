...
- [@aya/mobile](./packages/mobile.md) _(mobile)_ — RN app — typed API client, camera/scan state machines, local-first page store, tappable reader view, tap-to-translate phrase popup, inline scan-error UI. Share flow todo.
