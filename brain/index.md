...
- [@aya/mobile](./packages/mobile.md) _(mobile)_ — RN app — typed API client, camera/scan state machines, local-first page store, tappable reader view, inline scan-error UI. Phrase popup, share flow todo.
